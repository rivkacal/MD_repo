...
!      read(60,*) AN ! number of atoms in simulation
      ...
      read(60,*) minTrajOut ! Lena's changes
! This flag when equals YES activates the output 
! of minimal Traj file: the minimal file does not contain any
